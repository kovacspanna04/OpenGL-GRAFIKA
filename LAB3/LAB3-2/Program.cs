...
namespace GrafikaSzeminarium
{
    internal class Program
    {
        ...
        private static float ambientStrength = 0.1f;        // fenyerosseg 10%
        ...
        private static Vector3 lightColor = new Vector3(1f, 1f, 1f);        // a feny szine

        private static Vector3 sideColor;
        private static int sideColorIndex = 0;  // szam alapjan valaszthato majd ki az oldal szine
        ...
        private static unsafe void GraphicWindow_Render(double deltaTime)
        {
            ...
            SetUniform3(LightColorVariableName, lightColor);        // RGB feny(vezerelheto IMGUI-val)
            ...
            ChangeColor(sideColorIndex);        // a sidecolorindex alapjan allitja be a szint
            ...
            // lenyilo lista a kocka oldalanak a szinet ezzel tudom kivalasztani
            ...
            // a feny szinet ezzel tudom modositani
