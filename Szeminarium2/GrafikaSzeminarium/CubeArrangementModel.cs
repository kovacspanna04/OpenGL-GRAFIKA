...
namespace Szeminarium
{
    internal class CubeArrangementModel
    {
        ...
        /// </summary>
        public double CenterCubeScale { get; private set; } = 1;   // nagy kocka

        /// <summary>
        /// The angle with which the diamond cube is rotated around the diagonal from bottom right front to top left back.
        /// </summary>
        public double DiamondCubeLocalAngle { get; private set; } = 0;   // kicsi kocka

        /// <summary>
        /// The angle with which the diamond cube is rotated around the global Y axes.
        /// </summary>
        public double DiamondCubeGlobalYAngle { get; private set; } = 0;   // nagy kocka
